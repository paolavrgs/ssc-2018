...
class DownloadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create download" do
    assert_difference('Download.count') do
      post downloads_url, params: { download: { description: @download.description, file: @download.file, position: @download.position, title: @download.title } }
    end
  ...
  test "should update download" do
    patch download_url(@download), params: { download: { description: @download.description, file: @download.file, position: @download.position, title: @download.title } }
